"""HTTP routes for patient-merge-service.

Generic CRUD over the `patient_merge` table. Every mutating endpoint publishes a
domain event (patient.merged) and an audit event; reads publish audit only.
